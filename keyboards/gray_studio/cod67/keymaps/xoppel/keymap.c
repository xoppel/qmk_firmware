...
// layer 0 - main
        LAYOUT(
                ...
                MO(1),   KC_LGUI, KC_LALT, xxxxxxx, xxxxxxx, KC_SPC,  xxxxxxx, xxxxxxx, xxxxxxx, KC_RALT, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT),

// layer 1 - functions
        LAYOUT(
                KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_CALC, \
                ...
                MO(1),   _______, _______, xxxxxxx, xxxxxxx, KC_BSPC, xxxxxxx, xxxxxxx, xxxxxxx, _______, _______, KC_MPRV, KC_PGDN, KC_MNXT),

// layer 2 - numpad
        LAYOUT(
                xxxxxxx, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_NLCK, \
                xxxxxxx, BL_DEC,  BL_INC,  BL_BRTG, xxxxxxx, KC_P7,   KC_P8,   KC_P9,   KC_PPLS, xxxxxxx, xxxxxxx, xxxxxxx, KC_BSPC, _______, \
                ...
                MO(1),   xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, KC_P0,   xxxxxxx, xxxxxxx, xxxxxxx, KC_PENT, xxxxxxx, KC_LEFT, KC_DOWN, KC_RGHT),
