...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT_65_ansi_blocker(
        ...
        MO(_FL1),KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(_FL1),          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FL1] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, KC_VOLD, KC_VOLU, KC_PGDN, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_INS,  _______, _______,                   _______, KC_VOLD,
        _______,          KC_WBAK, KC_WFWD, _______, _______, KC_PGUP, KC_END,  KC_MUTE, KC_MPRV, KC_MNXT, KC_MPLY, _______,          KC_PGUP, KC_MUTE,
        _______, _______, _______,                            KC_BSPC,                            MO(_FL2),_______,          KC_MPRV, KC_PGDN, KC_MNXT 
    ),
    [_FL2] = LAYOUT_65_ansi_blocker(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
        RGB_TOG, RGB_VAI, RGB_SAI, RGB_HUI, _______, _______, _______, _______, _______, _______, _______, KC_NLCK, _______,          _______, _______,
        _______, RGB_VAD, RGB_SAD, RGB_HUD, BL_TOGG, BL_DEC,  BL_INC,  _______, _______, _______, _______, _______,                   _______, _______,
