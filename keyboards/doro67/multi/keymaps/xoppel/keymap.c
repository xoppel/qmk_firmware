...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_BL] = LAYOUT_multi(
    ...
    MO(_FL), KC_LGUI, KC_LALT,          KC_BSPC, KC_DEL,  KC_SPC,           KC_RALT, MO(_FL), xxxxxxx,          KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  */
  [_FL] = LAYOUT_multi(
    ...
    _______, _______, _______,          _______, _______, KC_BSPC,          MO(_CL), _______, xxxxxxx,          KC_MPRV, KC_PGDN, KC_MNXT 
  ),
