...
[1] = LAYOUT_60_all(
	...
	MO(2),   xxxxxxx, KC_WBAK, KC_WFWD, _______, _______, KC_PGUP, KC_END,  KC_MUTE, KC_MPRV, KC_MNXT, KC_MPLY, KC_UP,   KC_PGDN,
...
[2] = LAYOUT_60_all(
	...
	_______, xxxxxxx, RGB_RMOD,RGB_MOD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
