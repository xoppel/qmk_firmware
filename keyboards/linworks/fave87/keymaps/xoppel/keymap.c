...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	  ...
	  [0] = LAYOUT_all(
	    ...
	    MO(1),   KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, KC_RALT, KC_RGUI, MO(1),            KC_LEFT, KC_DOWN, KC_RGHT),
	  ...
	  [1] = LAYOUT_all(
	    ...
	    KC_ESC,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL, KC_DEL,   _______, _______, KC_VOLU,
	    ...
	    _______, _______, KC_WBAK, KC_WFWD, _______, _______, KC_PGUP, KC_END,  KC_MUTE, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______,                   KC_PGUP,
