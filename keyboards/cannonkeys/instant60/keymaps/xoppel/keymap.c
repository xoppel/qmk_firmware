...
[1] = LAYOUT_60_ansi(
	...
	MO(2),   KC_WBAK, KC_WFWD, _______, _______, KC_PGUP, KC_END,  KC_MUTE, KC_MPRV, KC_MNXT, KC_MPLY, KC_UP,
	_______, _______, KC_DEL,                             KC_BSPC,                            _______, KC_LEFT, KC_DOWN, KC_RGHT),

// Fn2 Layer
[2] = LAYOUT_60_ansi(
	_______, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, BL_BRTG, BL_DEC,  BL_INC,  KC_CALC,
	...
	RESET,   _______, _______,                            _______,                            _______, KC_LEFT, _______, KC_RGHT),
